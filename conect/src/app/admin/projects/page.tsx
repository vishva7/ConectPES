  ...
  const handleDelete = async (projectId: string) => {
    try {
      const response = await axios.delete(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/projects/delete/${projectId}`
      );
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        let newProjects = response.data.map((project: projects) => {
        ...
        newProjects.sort((a: projects, b: projects) => a.position - b.position);
                ...
                {projects.map((project, index) => (
                  ...
                  >
                    ...
                    <div className="lg:col-span-2">
                      ...
                      <CardFooter className="text-lg font-semibold flex justify-between">
                        {project.available ? (
